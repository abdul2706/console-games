class Tank {
    ...
    constructor(x, y, direction, bullet_counter_delay, direction_counter_delay) {
        this.x = x || 0;
        this.y = y || 0;
        this.direction = direction || 'up';
        this.bullet_counter = 0;
        this.bullet_counter_delay = bullet_counter_delay || Math.round(Math.random() * 50 + 50);
        this.direction_counter = 0;
        this.direction_counter_delay = direction_counter_delay || Math.round(Math.random() * 50 + 50);
